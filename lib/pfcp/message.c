...
ogs_tlv_desc_t ogs_pfcp_tlv_desc_blockchain_login =
    {
        OGS_TLV_VAR_STR,
        "Blockchain Login",
        OGS_PFCP_BLOCKCHAIN_LOGIN,
        0,
        0,
...
ogs_tlv_desc_t ogs_pfcp_msg_desc_pfcp_blockchain_credentials_request =
    {
        OGS_TLV_MESSAGE,
