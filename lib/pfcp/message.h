...
#define OGS_PFCP_BLOCKCHAIN_NODE_ID_REQUEST_TYPE 60
#define OGS_PFCP_BLOCKCHAIN_NODE_ID_RESPONSE_TYPE 61
...
#define OGS_PFCP_BLOCKCHAIN_NODE_ID 325
    ...
    extern ogs_tlv_desc_t ogs_pfcp_tlv_desc_blockchain_credentials;
    ...
    typedef struct ogs_pfcp_tlv_blockchain_credentials_s
    {
        ogs_tlv_presence_t presence;
        ogs_pfcp_tlv_blockchain_login_t login;
        ogs_pfcp_tlv_blockchain_pass_t password;
    } ogs_pfcp_tlv_blockchain_credentials_t;
