...
)
{
    ...
    access_and_mobility_subscription_data_1_local_var->blockchain_node_id = blockchain_node_id;
...
void OpenAPI_access_and_mobility_subscription_data_1_free(OpenAPI_access_and_mobility_subscription_data_1_t *access_and_mobility_subscription_data_1)
{
    ...
    if (access_and_mobility_subscription_data_1->blockchain_node_id) {
        OpenAPI_sdm_blockchain_node_id_free(access_and_mobility_subscription_data_1->blockchain_node_id);
        access_and_mobility_subscription_data_1->blockchain_node_id = NULL;
    }
...
cJSON *OpenAPI_access_and_mobility_subscription_data_1_convertToJSON(OpenAPI_access_and_mobility_subscription_data_1_t *access_and_mobility_subscription_data_1)
{
    ...
    if (access_and_mobility_subscription_data_1->blockchain_node_id) {
    cJSON *blockchain_node_id_local_JSON = OpenAPI_sdm_blockchain_node_id_convertToJSON(access_and_mobility_subscription_data_1->blockchain_node_id);
    if (blockchain_node_id_local_JSON == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_1_convertToJSON() failed [blockchain_node_id]");
        goto end;
    }
...
OpenAPI_access_and_mobility_subscription_data_1_t *OpenAPI_access_and_mobility_subscription_data_1_parseFromJSON(cJSON *access_and_mobility_subscription_data_1JSON)
{
    ...
    blockchain_node_id = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_data_1JSON, "blockchainNodeId");
